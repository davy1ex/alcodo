...
SECRET_KEY = '=n=0@oxf-1jz!*t(1$6jzu+-$^v2umpd!)5lz!07nf!b6t6y1*'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.login_redirect', # и эту
            ],
        },
    },
]

WSGI_APPLICATION = 'alcodo.wsgi.application'
